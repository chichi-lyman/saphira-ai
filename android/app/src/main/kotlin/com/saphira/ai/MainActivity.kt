...
//
// Host activity for Flutter. Handles assistant-invoked intents and overlay flag.
// If you already use Flutter's generated MainActivity, merge onNewIntent logic there.
...
class MainActivity : FlutterActivity() {
    ...
    private fun handleAssistantIntent(intent: Intent?) {
        ...
        if (fromAssistant) {
            Log.i(TAG, "Assistant invoked — requesting Flutter overlay")
